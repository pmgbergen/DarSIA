...
class Patches:
    ...
    Methods:
        assemble (darsia.Image): reassembles the patches to a new image
    """

    def __init__(self, img: darsia.Image, *args, **kwargs) -> None:
        """
        Constructor for Patches class.

        Arguments:
            im (darsia.Image): the Image that is to be patched
    ...
    def __call__(self, i: int, j: int) -> darsia.Image:
        """
        ...
        Returns:
            darsia.Image: image of the patch
        """
...
class GeneralPatches:
    """
    Class for patched general image.
    ...
    def __init__(
        self, img: darsia.GeneralImage, num_patches: list[int], **kwargs
    ) -> None:
        """
        Constructor for GeneralPatches class.

        Arguments:
            img (darsia.GeneralImage): image to be patched.
    ...
    def __call__(self, *args) -> darsia.GeneralImage:
        """
        ...
        Returns:
            darsia.GeneralImage: image of the indexed patch
