...
class RotationCorrectionAssistant:
    ...
    def __init__(self, img: darsia.Image, **kwargs) -> None:
        ...
        # Initialize anchor and src/dst points
        self._reset()
    ...
    def _plot_3d(self) -> None:
        ...
        self.fig = fig_2d
        self.ax = axs
        fig_2d.canvas.mpl_connect("button_press_event", self.on_mouse_click_3d)
        fig_2d.canvas.mpl_connect("key_press_event", self.on_key_press)
    ...
    def return_rotation_corrections(self) -> list[darsia.RotationCorrection]:
