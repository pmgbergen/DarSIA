...
def parse_color_path_embedding(
    ...
    _baseline_selector = cfg["baseline"]
    embedding.baseline_data = data_registry.resolve(_baseline_selector)
    _data_selector = cfg["data"]
    embedding.data = data_registry.resolve(_data_selector)
